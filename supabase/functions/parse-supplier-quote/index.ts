...
2. **CODE (كود الصنف - مهم جداً)**: code, رقم, كود, رمز, item_code, product_code, sku, الكود, رقم الصنف, Item No, No, #, Ref, المرجع. **انتبه: عمود الكود عادة يكون بجانب رقم التسلسل (ر.م) أو بجانب اسم الصنف. قد يحتوي على أرقام أو حروف وأرقام معاً. استخرجه دائماً إذا وُجد.**
...
- **code مهم جداً** - ابحث عنه في كل عمود قد يحتوي على كود/رقم/مرجع للصنف. لا تخلطه مع رقم التسلسل (ر.م). الكود عادة يكون مختلف عن ترتيب الصف.
