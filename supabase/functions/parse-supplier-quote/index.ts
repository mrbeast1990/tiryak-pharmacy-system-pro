...
2. **CODE (كود الصنف - أهم عمود بعد الاسم)**:
   - ابحث عن عمود يحتوي أي من هذه المسميات: code, كود, رقم, رمز, item_code, product_code, sku, الكود, رقم الصنف, Item No, No., #, Ref, المرجع, الرقم
   - **الكود هو NOT رقم التسلسل (ر.م / Serial / S/N)**. رقم التسلسل يكون 1, 2, 3, 4... بالترتيب. الكود يكون مختلف تماماً.
   - **الكود عادة يكون**: أرقام مثل 10045, 20312 أو حروف وأرقام مثل ABC123, MED-456
   - **الكود يأتي عادة في العمود الذي بعد ر.م (رقم التسلسل) وقبل أو بعد اسم الصنف مباشرة**
   - إذا وجدت عمودين رقميين: الأول تسلسلي (1,2,3...) والثاني غير تسلسلي = العمود الثاني هو الكود
   - **استخرج الكود دائماً إذا وُجد. لا تتركه فارغاً أبداً إذا كان موجوداً في الملف**
...
- **code مهم جداً** - إذا رأيت عموداً فيه أرقام غير تسلسلية (ليست 1,2,3...) بجانب اسم الصنف، فهذا هو الكود. استخرجه.
...
serve(async (req) => {
  ...
  try {
    // Require authenticated caller (prevents AI cost abuse)
