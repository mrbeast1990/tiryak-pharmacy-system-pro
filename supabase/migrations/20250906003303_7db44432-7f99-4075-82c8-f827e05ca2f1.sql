-- تعديل دور حساب thepanaceapharmacy@gmail.com من مدير إلى احمد الرجيلي
...
-- تحديث الدور الحالي للحساب الموجود
UPDATE public.profiles 
SET role = 'ahmad_rajili'
WHERE id IN (
  SELECT id FROM auth.users WHERE email = 'thepanaceapharmacy@gmail.com'
);