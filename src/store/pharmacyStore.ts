...
interface PharmacyState {
  ...
  addRevenue: (revenue: Omit<Revenue, 'id' | 'created_at' | 'createdBy' | 'created_by_id' | 'attachment_url' | 'voice_note_url'> & { created_by_name_override?: string; attachment_url?: string | null; voice_note_url?: string | null; is_note_only?: boolean }) => Promise<boolean>;
