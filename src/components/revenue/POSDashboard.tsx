...
import { DollarSign, Building2, TrendingUp, ChevronLeft, ChevronRight, Lock, LockOpen } from 'lucide-react';
...
const POSDashboard: React.FC<POSDashboardProps> = ({
  ...
  return (
    <Card
      className={`border-0 shadow-lg rounded-2xl overflow-hidden transition-colors ${isLocked ? 'bg-muted/60' : 'bg-card'}`}
    >
