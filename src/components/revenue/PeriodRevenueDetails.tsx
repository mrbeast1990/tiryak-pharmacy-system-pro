          ...
          <Card className="card-shadow mb-6">
            <CardContent className="pt-6">
              <div className="text-center mb-4">
                ...
                <p className="text-2xl font-bold text-green-600">{periodRevenue.toFixed(2)} دينار</p>
              </div>
            </CardContent>
          </Card>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900">
                          ({revenue.date}) - {revenue.period === 'morning' ? 'صباحية' : 
                        ...
                        {revenue.notes && (
                          <p className="text-sm text-gray-500 mt-1">الملاحظات: {revenue.notes.replace('- Income', '').replace('- Cash Disbursement', '').trim()}</p>
                        )}
                      </div>
            ...
            {periodRevenues.length === 0 && (
              <Card className="card-shadow">
                <CardContent className="p-8 text-center">
                  <p className="text-gray-500">لا توجد عمليات في هذه الفترة</p>
                </CardContent>
              </Card>
            )}
          </div>
